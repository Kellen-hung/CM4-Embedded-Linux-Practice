...
net.load_param("models/picodet_m_416_int8_mixed5300_old.param")
net.load_model("models/picodet_m_416_int8_mixed5300_old.bin")

# net.load_param("../models/picodet_m_416_int8_scene300.param")
# net.load_model("../models/picodet_m_416_int8_scene300.bin")

# net.load_param("../models/picodet_m_416_opt.param")
# net.load_model("../models/picodet_m_416_opt.bin")
...
cv2.imwrite(f"results-img/{DIRECTION}_picodet_int8.jpg", image)
print(f"Saved: results-img/{DIRECTION}_picodet_int8.jpg")